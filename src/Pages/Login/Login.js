...
const Login = () => {
    ...
    return (
        <div className='flex justify-center my-10'>
            <div className="w-full max-w-md p-8 space-y-3 rounded-xl border border-gray-900 shadow-xl shadow-black dark:text-gray-100">
                <h1 className="text-2xl font-bold text-center">Login</h1>
                <form onClick={handleLogin} novalidate="" action="" className="space-y-6">
                    ...
                    <button className="block btn btn-info w-full p-3 text-center rounded-lg dark:text-gray-900 dark:bg-violet-400">Sign in</button>
                </form>
                ...
                <div className="flex justify-center space-x-4">
                    <button onClick={handleGoogleLogin} type='submit' aria-label="Log in with Google" className="p-3 rounded-sm">
